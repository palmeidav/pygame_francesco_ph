...
def carrega_arquivos():
    ...
    dicionario_de_arquivos['caixa'] = pygame.image.load(os.path.join(IMG_DIR, 'caixa.png')).convert()
    dicionario_de_arquivos['caixa_correto'] = pygame.image.load(os.path.join(IMG_DIR, 'caixa_correto.png')).convert()
    ...
    dicionario_de_arquivos['font_menor'] = pygame.font.Font(os.path.join(FNT_DIR, 'PressStart2P.ttf'), 18)
